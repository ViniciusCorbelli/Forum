...
<div class="row">
        <div class="form-group col-6">
            <label for="password" class="{{ !Route::is('profile.users.edit') ? 'required' : '' }}" >Senha </label>
            <div class="input-group">
                ...
                <input autocomplete="new-password" type="password" class="senhaID form-control" name="password" id="password" {{ !Route::is('profile.users.edit') ? 'required' : '' }}>
            </div>
        </div>
        <div class="form-group col-md-6 col-sm-12">
            <label for="password" class="{{ !Route::is('profile.users.edit') ? 'required' : '' }}">Confirme sua senha</label>
            <input  autocomplete="new-password" type="password" class="senhaID form-control" name="password_confirmation" id="password" {{ !Route::is('profile.users.edit') ? 'required' : '' }}>
        </div>
</div>
