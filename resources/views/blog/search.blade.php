    ...
    <div class="container">
        <div class="verticals ten offset-by-one">
            <ol class="breadcrumb breadcrumb-fill2">
                ...
                <li>Pesquisa</li>
                <li class="active-breadcrumb"> {{ $search }}</li>
            </ol>
        </div>
        <div class="row">
            <div class="col-sm-12">
                <div class="card-post categories">
                    <h1>Pesquisa: <strong> {{ $search }}</strong> </h1>
                        ...
                        <div class="row">
                            ...
                            <div class="col-4 text-right">
                                ...
                                @if ($lastComment->first() != null)
                                    <h6>{{ $lastComment->first()->user->name }}, {{ date('d/m/Y H:i', strtotime($lastComment->first()->created_at)) }} 
                                    </h6>
                                @else
